...
/**
 * Client-side hook to access the authenticated user and auth methods.
 * Must be used within an AuthProvider (client components only).
 */
...
/**
 * Client-side hook for backward compatibility.
 * Returns { user, isLoading, error } with error as an Error object.
 */
